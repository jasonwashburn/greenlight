...
import (
	...
	"github.com/jasonwashburn/greenlight/internal/validator"
...
func (app *application) writeJSON(w http.ResponseWriter, status int, envelope envelope, headers http.Header) error {
